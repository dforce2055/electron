  ...
  <div class="bg-white">
    <main>
      ...
      <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-14 lg:px-8">
        ...
        >
          <path fill="url(#10724532-9d81-43d2-bb94-866e98dd6e42)"
                fill-opacity=".2"
                d="M301.174 646.641 193.541 844.786 0 546.172l301.174 100.469 193.845-356.855c1.241 164.891 42.802 431.935 199.124 180.978 195.402-313.696 143.295-588.18 284.729-419.266 113.148 135.13 124.068 367.989 115.378 467.527L811.753 372.553l20.102 451.119-530.681-177.031Z"
          />
          <defs>
            <linearGradient id="10724532-9d81-43d2-bb94-866e98dd6e42"
                            x1="1097.04"
                            x2="-141.165"
                            y1=".22"
                            y2="363.075"
        ...
        >
          <path fill="url(#8ddc7edb-8983-4cd7-bccb-79ad21097d70)"
                fill-opacity=".2"
                d="M301.174 646.641 193.541 844.786 0 546.172l301.174 100.469 193.845-356.855c1.241 164.891 42.802 431.935 199.124 180.978 195.402-313.696 143.295-588.18 284.729-419.266 113.148 135.13 124.068 367.989 115.378 467.527L811.753 372.553l20.102 451.119-530.681-177.031Z"
          />
          <defs>
            <linearGradient id="8ddc7edb-8983-4cd7-bccb-79ad21097d70"
                            x1="1097.04"
                            x2="-141.165"
                            y1=".22"
                            y2="363.075"
        ...
        <div class="mx-auto max-w-7xl py-44 sm:py-48">
          <div class="mx-auto max-w-2xl text-center">
            <img 
              src="/img/banner.png"
              alt=""
              class="absolute inset-0 -z-10 w-full object-cover"
            >
          </div>
          <div class="mx-auto max-w-2xl text-center md:mt-32">
          ...
          <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-8">
            ...
            <div class="flex gap-x-4 rounded-xl bg-white/5 p-6 ring-1 ring-inset ring-white/10">
              <BuildingOffice2Icon class="h-7 w-5 flex-none text-indigo-400"
                                   aria-hidden="true"
              />
              <div class="text-base leading-7">
                <h3 class="font-semibold text-white">
      ...
      <!-- Contact form -->
      <div class="relative isolate px-6 pt-24 sm:pt-40 lg:px-8">
        <div class="absolute inset-0 -z-10 overflow-hidden">
          <svg viewBox="0 0 1155 678"
               aria-hidden="true"
               class="absolute bottom-full -left-40 -mb-48 w-[72.1875rem] transform-gpu blur-3xl sm:left-auto sm:right-1/2 sm:-mb-64"
          >
            <path fill="url(#d5d4d369-6b90-4398-a6aa-ab9a062d6e3c)"
                  fill-opacity=".25"
            ...
            />
            <defs>
              <linearGradient id="d5d4d369-6b90-4398-a6aa-ab9a062d6e3c"
                              x1="1155.49"
                              x2="-78.208"
                              y1=".177"
                              y2="474.645"
        ...
        <div class="mx-auto max-w-xl">
          ...
          <p class="mt-2 text-lg leading-8 text-gray-600">
            Send us the details of your project to obtain a quotation.
          </p>
        </div>
        <form
              ...
              <div class="relative mt-2.5">
                <div class="absolute inset-y-0 left-0 flex items-center">
                  ...
                  <select 
                    id="country"
                    name="country"
                    class="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-sm text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-600"
                  >
                    <option>AR</option>
                    <option>US</option>
                    <option>CA</option>
                ...
                <input 
                  ...
                  name="phone-number"
                  autocomplete="tel"
                  class="block w-full rounded-md border-0 py-2 px-3.5 pl-20 text-sm leading-6 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600"
                >
              </div>
            </div>
            <div class="sm:col-span-2">
    ...
    <footer class="mx-auto mt-24 max-w-7xl overflow-hidden px-6 pb-20 sm:mt-40 sm:pb-24 lg:px-8">
      ...
      <p class="mt-10 text-center text-xs leading-5 text-gray-500">
        &copy; {{  new Date().getFullYear() }} Electron, Inc. All rights reserved.
      </p>
    </footer>
    <!-- Dialog -->
...
const footerNavigation = {
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/Electron.Net/',
